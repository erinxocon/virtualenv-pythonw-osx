...
def main(argv):
    ...
    python_app_src = path.join(path.dirname(dot_python_src), 'Resources', 'Python.app')
    ...
    pythonw_executable = path.join(python_app_dest, 'Contents', 'MacOS', 'Python')
    call(['install_name_tool', '-change', dot_python_src, dot_python, pythonw_executable])
